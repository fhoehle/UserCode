...
class TtEvent {
 ...
 public:
  ...
  enum HypoClassKey {kGeom, kWMassMaxSumPt, kMaxSumPtWMass, kGenMatch, kMVADisc, kKinFit, kKinSolution, kWMassDeltaTopMass, kHitFit, kOwnTopMassBTag, kOwnM3BTag, kOwnPseudoMatchBJetCalcNu,kOwnPseudoMatchBJetGenNu,kOwnPseudoMatchBJetMatchedCalcNu,kOwnPseudoGenBCalcNu,kOwnPseudoGenBMatchedCalcNu};
