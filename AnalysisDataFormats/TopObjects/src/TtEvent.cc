...
TtEvent::hypoClassKeyFromString(const std::string& label) const 
{
   static HypoClassKeyStringToEnum hypoClassKeyStringToEnumMap[] = {
      ...
      { "kHitFit",            kHitFit           },
		{ "kOwnTopMassBTag",		kOwnTopMassBTag	},
		{ "kOwnM3BTag",			kOwnM3BTag			},
		{ "kOwnPseudoMatchBJetCalcNu",			kOwnPseudoMatchBJetCalcNu			},
	   { "kOwnPseudoMatchBJetGenNu",kOwnPseudoMatchBJetGenNu		},
		{ "kOwnPseudoMatchBJetMatchedCalcNu",kOwnPseudoMatchBJetMatchedCalcNu},
		{ "kOwnPseudoGenBCalcNu",			kOwnPseudoGenBCalcNu			},
		{ "kOwnPseudoGenBMatchedCalcNu",			kOwnPseudoGenBMatchedCalcNu			},
      { 0, (HypoClassKey)-1 }
   };
