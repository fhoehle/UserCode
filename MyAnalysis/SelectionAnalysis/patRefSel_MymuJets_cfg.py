...
# list of input files
useRelVals = False #FH True # if 'False', "inputFiles" is used
inputFiles = [#'file:/user/hoehle/CMSSW/CMSSW_datasets/CMSSW442/nonsemiMuon_ttbarSkim.root'#semiMuon_ttbarSkim.root' 
		'file:/user/hoehle/CMSSW/CMSSW_datasets/CMSSW442/F25BCF39-AD04-E111-86B2-002354EF3BDF.root'# Fall11 TTbar
...
globalTagData = 'GR_R_44_V11' #FH 'GR_R_42_V19' # default for CMSSW_4_2_8 RelVals: 'GR_R_42_V14'
globalTagMC   = 'START44_V7' #FH 'START42_V13' # default for CMSSW_4_2_8 RelVals: 'START42_V12'

### Output

# output file
outputFile = 'patRefSel_muJets_semimuon_ttbar_Fall11.root'
...
if runPF2PAT:
  ...
  process.load('CommonTools.ParticleFlow.Isolation.isoValMuonWithCharged_cfi') # FH
  process.load('CommonTools.ParticleFlow.Isolation.isoValMuonWithNeutral_cfi') # FH
  process.load('CommonTools.ParticleFlow.Isolation.isoValMuonWithPhotons_cfi') # FH
  ...
  applyPostfix( process, 'pfIsolatedMuons'      , postfix ).isolationCut = pfMuonCombIsoCut # FH
  ...
  applyPostfix( process, 'pfIsolatedElectrons'      , postfix ).isolationCut = pfElectronCombIsoCut # FH
