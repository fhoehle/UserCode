...
addTtSemiLepHypotheses(process,
                       ["kGeom", "kWMassDeltaTopMass", "kWMassMaxSumPt", "kMaxSumPtWMass", "kMVADisc", "kKinFit","kHitFit","kOwnTopMassBTag","kOwnM3BTag","kOwnPseudoMatchBJetCalcNu" 
,"kOwnPseudoMatchBJetGenNu","kOwnPseudoMatchBJetMatchedCalcNu"]
                       )
