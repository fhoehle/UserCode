...
#include "TopQuarkAnalysis/TopJetCombination/plugins/TtSemiLepHypOwnPseudoMatchBJetMatchedCalcNu.h" // OwnPseudoMatchBJetMatchedCalcNu
#include "TopQuarkAnalysis/TopTools/interface/MyMEzCalculator.h"
#include "FWCore/MessageLogger/interface/MessageLogger.h"
#include "Math/VectorUtil.h"
TtSemiLepHypOwnPseudoMatchBJetMatchedCalcNu::TtSemiLepHypOwnPseudoMatchBJetMatchedCalcNu(const edm::ParameterSet& cfg):
...
TtSemiLepHypOwnPseudoMatchBJetMatchedCalcNu::~TtSemiLepHypOwnPseudoMatchBJetMatchedCalcNu() { }

void
TtSemiLepHypOwnPseudoMatchBJetMatchedCalcNu::buildHypo(edm::Event& evt,
