...
TtSemiLeptonicEvent::print(const int verbosity) const
{
  ...
  for(EventHypo hyp = evtHyp_.begin(); hyp != evtHyp_.end(); ++hyp) {
    ...
    case kKinFit            : log << " KinFit"           ; break;
	 case kHitFit				 : log << " kHitFit"				; break;
	 case kOwnTopMassBTag	 : log << " kOwnTopMassBTag"  ; break;
	 case kOwnM3BTag			 : log << " kOwnM3BTag"			; break;
	 case kOwnPseudoMatchBJetCalcNu : log << " kOwnPseudoMatchBJetCalcNu"			; break;
	 case kOwnPseudoMatchBJetGenNu : log << "kOwnPseudoMatchBJetGenNu" ; break;
	case kOwnPseudoMatchBJetMatchedCalcNu : log << " kOwnPseudoMatchBJetMatchedCalcNu"			; break;
    default                 : log << " Unknown";
    }
    log << "-Hypothesis: \n";
