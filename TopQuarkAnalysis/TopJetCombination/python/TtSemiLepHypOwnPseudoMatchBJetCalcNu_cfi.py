...
#
# module to make the ownPseudoMatchBJetCalcNu hypothesis
#
ttSemiLepHypOwnPseudoMatchBJetCalcNu = cms.EDProducer("TtSemiLepHypOwnPseudoMatchBJetCalcNu",
    ## met input
    ...
    ## max DeltaR jet - blep-parton
    maxDeltaR = cms.double(0.4),
    ## topmass
    topMass =  cms.double(172.4),
    ## max energyfraction of blep-parton
    maxEfrac = cms.double(0.4),
