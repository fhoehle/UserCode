...
#
# module to make the ownTopMassBTag hypothesis
#
ttSemiLepHypOwnTopMassBTag = cms.EDProducer("TtSemiLepHypOwnTopMassBTag",
    ## met input
    ...
    ## maximal number of jets to be considered, -1 all, otherwise first n n has to  >= 2
    maxNJets = cms.int32(-1),
    ## nominal WMass parameter (in GeV)
    wMass = cms.double(80.4),
    ## nominal TopMass parameter (in GeV)
